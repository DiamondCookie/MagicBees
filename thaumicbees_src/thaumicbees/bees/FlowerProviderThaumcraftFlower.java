...
{
	private ItemStack[] flowers = {new ItemStack(BlockManager.ThaumcraftPlant, 1, 2), new ItemStack(BlockManager.ThaumcraftPlant, 1, 3) };
			
	@Override
	public boolean isAcceptedFlower(World world, IBeeGenome genome, int x, int y, int z)
	{
		boolean flag = false;
		if (world.getBlockId(x, y, z) == BlockManager.ThaumcraftPlant.blockID)
		{
